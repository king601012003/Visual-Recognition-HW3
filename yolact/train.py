...
parser.add_argument('--save_epoch', default=4, type=int,
...
parser.add_argument('--keep_latest_interval', default=100000, type=int,
                    help='When --keep_latest is on, don\'t delete the latest file at these intervals. This should be a multiple of save_epoch or 0.')
        ...
        for epoch in range(num_epochs):
            ...
            if epoch % args.save_epoch == 0:
                ...
                if args.keep_latest and latest is not None:
                    if args.keep_latest_interval <= 0 or iteration % args.keep_latest_interval != args.save_epoch:
